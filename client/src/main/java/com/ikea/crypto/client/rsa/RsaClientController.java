...
public class RsaClientController extends AbstractClientController {
    ...
    public RsaClientController(
        ...
        this.rsaCryptoClient = new RsaCryptoClient(new RsaHttpClient(serverBaseUri, rsaPublicKeyPath));
    }

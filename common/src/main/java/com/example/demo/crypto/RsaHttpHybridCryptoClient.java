...
public class RsaHttpHybridCryptoClient implements PublicKeyProvider {
    private final HttpClient httpClient;
    private final URI serverBaseUri;
    private final ObjectMapper objectMapper;

    public RsaHttpHybridCryptoClient(URI serverBaseUri) {
    ...
    public String decryptEncryptedData(RsaHybridCipherPayload payload) throws IOException, InterruptedException {
